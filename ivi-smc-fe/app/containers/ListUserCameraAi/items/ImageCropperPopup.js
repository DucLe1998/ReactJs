...
function ImageCropper({ onClose, fileImage, setCroppedFileImage }) {
  const intl = useIntl();
  ...
  const onCrop = () => {
    if (typeof cropper !== 'undefined') {
      ...
      if (
        ...
        canvasBlob.then(
          blob => {
            const file = new File([blob], fileImage.name, {
              type: 'image/jpeg',
            });
            setCroppedFileImage(file);
            setLoading(false);
          },
          () => {
            setLoading(false);
    ...
    <Modal>
      ...
      <div className={classes.imageContainer}>
        ...
        <Button
          ...
          // text="Tìm kiếm"
          text={intl.formatMessage(messages.search_text)}
          type="success"
          onClick={() => {
            onCrop();
          }}
