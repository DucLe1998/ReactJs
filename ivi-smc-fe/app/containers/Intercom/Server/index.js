...
// COLUME TABLE
import { COLUMNS_LIST, initValueFilter, titlePopup } from './constants';
import CustomTable from 'components/Custom/table/CustomTable';

// Mocdata
import { deviceList } from '../Mocdata/server';
import { SERVER_API } from 'containers/apiUrl'
...
export function Device() { 
  ...
  const fetchDataListDevice = async (id) => {
    ...
    setLoading(true);
    try {
      const res = await callApi(`${SERVER_API.GET_LIST}?${dto}`, 'GET');
