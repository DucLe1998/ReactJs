...
import Filter from './creens/FilterDiscount';
const initialFilter = {
  keyword: null,
  timeFrom: null,
  timeTo: null,
...
export function ParkingDiscountReport() {
...
export default ParkingDiscountReport;
